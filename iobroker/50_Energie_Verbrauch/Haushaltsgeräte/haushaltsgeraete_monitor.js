...
(async function() {
    ...
    const APPLIANCES_CONFIG = [
        ...
        },
        {
            ...
            startingThreshold: 9.2,
            finishingThreshold: 4.2,
            startingHysteresisMin: 2,
            finishingHysteresisMin: 5,
            pauseHysteresisMin: 15,
        },
        ...
        {
            deviceName: 'Bambulab A1',
            powerSensorId: 'zigbee2mqtt.0.0xa4c138053b27ffff.load_power',
            energySensorId: 'zigbee2mqtt.0.0xa4c138053b27ffff.energy',
            startingThreshold: 10.0,
            finishingThreshold: 5.0,
            startingHysteresisMin: 2,
            finishingHysteresisMin: 5,
        ...
        {
            deviceName: 'Pflanzenlicht Keller',
            powerSensorId: 'zigbee2mqtt.0.0xa4c13805a79bffff.load_power',
            energySensorId: 'zigbee2mqtt.0.0xa4c13805a79bffff.energy',
            startingThreshold: 10.0,
            finishingThreshold: 5.0,
            startingHysteresisMin: 2,
            finishingHysteresisMin: 5,
