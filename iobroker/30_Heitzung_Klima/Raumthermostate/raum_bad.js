 ...
 * @version 6.15 (Paket 1: Global-Header + Math.log10-Bugfix)
 * @author Sanweb
 * @license MIT
 *
 * -------------------------------------------------------------------------------------
    ...
    async function main() {
        try {
            ...
            if (!istSonderfall) {
                ...
                // --- 4.3 PHYSIK-MODULE & WETTERFÜHRUNG (Maximum-Prinzip) ---
                ...
                // Kandidat B: Schimmelschutz — BUGFIX V6.15: Math.log10() statt Math.log()
