 ...
 * - BUGFIX: Lernwerte-Pfad zeigt nun korrekt auf Kueche (vorher: Badezimmer)
...
(function () {
    ...
    const CONFIG = {
        ...
        // BUGFIX V6.15: Korrekter Pfad Kueche (vorher fälschlicherweise Badezimmer)
        // HINWEIS: Datenpfad nutzt 'Kueche' ohne Umlaut, identisch zur SQL-Tabelle (raum='Kueche')
        lernwerte: {
