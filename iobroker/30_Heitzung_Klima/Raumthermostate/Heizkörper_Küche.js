...
const CONFIG = {
    ...
    devices: {
        ...
        tuerSensor: 'hm-rpc.0.00000000000000.1.STATE',
    ...
    basisRegelung: {
        ...
        heizkurvenfaktor: 0.10,      // V6.11: Reduziert von 0.25 auf 0.10
        luftfeuchteOptimal: 70.0,    // Beibehalten (Küche spezifisch)
...
async function main() {
    try {
        ...
        const basisSollTemp = neueSollTemp; // Basis (z.B. 21.0)
...
schedule('4,19,34,49 * * * *', () => triggerCalculation(false)); 
